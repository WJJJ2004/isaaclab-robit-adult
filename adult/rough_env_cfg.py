...
2. mdp.body_incoming_wrench >> has no proper return type 
    ...
    class CriticCfg(ObservationGroupCfg):
        ...
        body_poses = ObsTerm(
            ...
            params={
                "asset_cfg": SceneEntityCfg(
                    "robot",
                    body_names=["torso_dummy_1","left_foot_1", "right_foot_1"],
                )
            },
            noise=Unoise(n_min=-0.0001, n_max=0.0001),
        )
    ...
    def __post_init__(self):
        ...
        self.events.physics_material = EventTerm(
            ...
            params={
                ...
                "static_friction_range": (0.05, 4.0), # (0.1, 2.0) 
                "dynamic_friction_range": (0.05, 4.0), # (0.1, 2.0)
                "restitution_range": (0.05, 4.0), # (0.0, 0.1)
                "num_buckets": 64,
        ...
        self.events.randomize_actuator_gains = EventTerm(
            ...
            params={
                ...
                "stiffness_distribution_params": (0.5, 1.5), # (0.8, 1.2)
                "damping_distribution_params": (0.5, 1.5), # (0.8, 1.2)
                "operation": "scale",
                "distribution": "uniform",
            },
        )
        ...
        self.events.randomize_joint_properties = EventTerm(
            ...
            params={
                "asset_cfg": SceneEntityCfg("robot", joint_names=".*"),
                "friction_distribution_params": (0.0, 0.5), # (0.0, 0.3)
                "armature_distribution_params": (0.5, 1.5), # (0.8, 1.2)
                "operation": "scale",
                "distribution": "uniform",
            },
        )
